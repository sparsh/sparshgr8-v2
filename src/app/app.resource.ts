...
export class Resource {
    ...
    platform = "Platform"
    hireSendSuccess = "Thanks for placing Hiring Request, I will be Looking forward to work with you.";
    hireMessage = "Please Enter some Details About the overall task";
    priceType = [
        { value: "fixed", display: "Fixed" },
        { value: "per hour", display: "Hourly Basis" }
    ]
    technologiesArray = [
        { showFront: true, path: "assets/android-outline.png", hover: "Android And Sparsh", text: "Android", marks: "95%" },
        { showFront: true, path: "assets/angular-outline.png", hover: "Angular And Sparsh", text: "Angular", marks: "80%" },
        { showFront: true, path: "assets/ionic-outline.png", hover: "Ionic And Sparsh", text: "Ionic", marks: "90%" },
        { showFront: true, path: "assets/firebase-outline.png", hover: "Firebase And Sparsh", text: "Firebase", marks: "70%" },
        { showFront: false, path: "assets/php-outline.png", hover: "Firebase And Sparsh", text: "PHP", marks: "40%" }
    ]
    ...
    toolbarIconsArray = [{
        ...
        routeLink: "client_feedback",
        toolbarTitle: "Client Feedback",
        icon: "content_paste"
    ...
    + "<b> 2 Applications In Angular 4 </b>and <b>2 application in hybrid mobile technology</b>.<br>"
    ...
    hireMarksHint = "Give marks to sparsh out of 5"
    hireMarks = "Hire Marks"
clientMessagePost = "Write something about Sparsh's performance"
